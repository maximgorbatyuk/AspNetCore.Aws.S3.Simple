...
public class LocalS3ConfigProvider : IS3ConfigProvider
{
    private readonly S3StorageSettings _s3StorageSettings;

    public LocalS3ConfigProvider(S3StorageSettings s3StorageSettings)
    {
    ...
    {
        return _s3StorageSettings.LocalstackConfig();
    }
}